...
const Portfolio = () => {
    return (
        <div className='m-5 p-5 shadow-none lg:shadow-2xl rounded-box'>
            <div className='flex flex-col-reverse mx-10 mt-4 lg:mt-10'>
                ...
                <div className='flex-1 mb-6 lg:mb-0'>
                    <h2 className='text-center lg:text-right text-2xl lg:text-4xl'>Ahmed-Al-Azmain</h2>
                    <h5 className='text-center lg:text-right text-lg lg:text-2xl'>Front End Web Developer</h5>
                </div>
            </div>
            <div className="divider px-10"></div>
            <div className='block lg:flex justify-between py-5'>
                <div className='ml-0 lg:ml-10'>
                    <h2 className='text-xl lg:text-2xl mb-3 uppercase'>Technical Skills</h2>
                ...
                <div className='mr-10'>
                    <h2 className='text-xl lg:text-2xl mt-6 lg:mt-0 mb-3 uppercase'>Educational Background</h2>
            ...
            <div className='mb-10'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mx-2 lg:mx-10'>
