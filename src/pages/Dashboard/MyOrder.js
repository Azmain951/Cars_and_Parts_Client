    ...
    return (
        <tr class="hover">
            ...
            <td>
                ...
                {paid ? <p><small>Transaction ID:<br /><span className='text-success font-bold'>{transactionId}</span></small></p> : <button className='btn btn-xs btn-error ml-3'>Cancel</button>}
            </td>
        </tr>
    );
};
